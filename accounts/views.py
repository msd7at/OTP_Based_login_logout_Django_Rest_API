...
from topfive import views as topfive_view
            ...
            if user.exists():
                ...
                if key:
                    ...
                    if old.exists():
                        ...
                        conn.request("GET", "https://2factor.in/API/R1/?module=SMS_OTP&apikey="""YOUR API KEY """/&to="+phone+"&otpvalue="+str(key)+"&templatename=WomenMark1")
    ...
    def post(self, request, *args, **kwargs):
        ...
        if phone and otp_sent:
            ...
            if old.exists():
                ...
                conn.request("GET", "https://2factor.in/API/V1/"""YOUR API KEY """/SMS/VERIFY/"+otp_session_id+"/"+otp_sent)
                res = conn.getresponse()    
                data = res.read()
                print(data.decode("utf-8"))
                data=data.decode("utf-8")
...
class LoginAPI(KnoxLoginView):
    ...
    def red(self,request):
        topfive_view.send_mail()
        topfive_view.PrintTopFive(request)
